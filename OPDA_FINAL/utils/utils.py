...
def get_model(net, len_features, num_class=-1, unit_size=100):############## You need to change this at each evaluation
    if net == 'alex':
        model_g = AlexBase()
        ...
        #print(len_features)
        model_g = ResBase(option = net, len_features = len_features, unit_size=unit_size)
