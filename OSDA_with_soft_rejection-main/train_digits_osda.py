...
Source_train = pd.read_csv("/content/drive/MyDrive/OSDA_Papers_adaptation/OSDA_with_soft_rejection-main/data/Source_train.csv")
Source_test = pd.read_csv("/content/drive/MyDrive/OSDA_Papers_adaptation/OSDA_with_soft_rejection-main/data/Source_test.csv")
Target_train = pd.read_csv("/content/drive/MyDrive/OSDA_Papers_adaptation/OSDA_with_soft_rejection-main/data/Target_train.csv")
Target_test = pd.read_csv("/content/drive/MyDrive/OSDA_Papers_adaptation/OSDA_with_soft_rejection-main/data/Target_test.csv")
...
target_dataset_test = PytorchDataSet(Target_test, len_features)
source_dataset = PytorchDataSet(Source_train, len_features)
target_dataset = PytorchDataSet(Target_train, len_features)
...
source_loader = torch.utils.data.DataLoader(source_dataset, batch_size=args.batch_size, shuffle=True, num_workers=1, worker_init_fn=np.random.seed(args.seed))
target_loader = torch.utils.data.DataLoader(target_dataset, batch_size=args.batch_size, shuffle=True, num_workers=1, worker_init_fn=np.random.seed(args.seed))
target_test_loader = torch.utils.data.DataLoader(target_dataset_test, batch_size=args.batch_size, shuffle=False, num_workers=1, worker_init_fn=np.random.seed(args.seed))
